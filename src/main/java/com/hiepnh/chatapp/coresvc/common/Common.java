...
public class Common {
    ...
    public static final String EXCEL_DIRECTORY = "src/main/resources/excel/";
    public static final String EXCEL_TEMPLATE = "Gateway_Template.xlsx";
    public static final String EXCEL_EXPORT = "GatewayList";
}
